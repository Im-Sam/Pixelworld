...
function populateVehicles(data, pdata) {
    ...
    $.each(data, function (index, category) {
        ...
        $.each(category.vehicles, function (index, vehicle) {
            ...
            var img = new Image();
            var url = 'https://assets.pixelworldrp.com/images/vehicles/'+vehicle.model+'.png';
            img.onload = function(){
                $('#' + vehicle.model + '-image').append('<img src="https://assets.pixelworldrp.com/images/vehicles/'+vehicle.model+'.png" class="img-fluid img-thumbnail">');
                $('#modelImage-' + vehicle.model).append('<img src="https://assets.pixelworldrp.com/images/vehicles/'+vehicle.model+'.png" class="img-fluid img-thumbnail">');
            };
