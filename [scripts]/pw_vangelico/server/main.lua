...
AddEventHandler('pw_vangelico:server:awardSafe', function(safe)
    ...
    _char:Inventories():AddItem():Player().Single('valuegood', amount, {['public'] = {}, ['private'] = {} })
...
AddEventHandler('pw_vangelico:server:awardItems', function(spot)
    ...
    _char:Inventories():AddItem():Player().Single(Config.Award[itemIndex].item, itemAmount, {['public'] = {}, ['private'] = {} })
end)
