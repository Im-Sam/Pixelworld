...
function MFD:Awake(...)
    ...
    PW.TriggerServerCallback('pw_weed:GetStartData', function(retVal) self.dS = true; self.cS = retVal; end)
...
AddEventHandler('pw_weed:UseSeed', function(seed, seedName) if MFD.iR then MFD:UseSeed(seed, seedName); end; end)
AddEventHandler('pw_weed:UseItem', function(item, seedType, data) if MFD.iR then MFD:UseItem(item, seedType, data); end; end)
AddEventHandler('pw_weed:SyncPlant', function(plant,del) if MFD.iR then MFD:SyncHandler(plant,del); end; end)
AddEventHandler('pw_weed:UseBag', function(canUse,msg) MFD:UseBag(canUse,msg); end)

RegisterNetEvent('pw_coke:client:showing')
AddEventHandler('pw_coke:client:showing', function(status)
  showing = status
end)

exports('getCokeShowing', function()
  return showing
end)