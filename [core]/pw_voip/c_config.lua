...
TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSChannel = "FiveM Server 1",
		TSPassword = "Server1Alpha", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "FiveM Server Queue",
...
AddEventHandler('pw:characterLoaded', function(data)
	...
	playerLoaded = true
		Citizen.CreateThread(function()
			TokoVoipConfig.plugin_data.localName = playerData.name; -- Set the local name
		end)
