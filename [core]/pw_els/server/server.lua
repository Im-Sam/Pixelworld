...
RegisterServerEvent("pw_els:requestVehiclesUpdate")
AddEventHandler('pw_els:requestVehiclesUpdate', function()
	TriggerClientEvent("pw_els:updateElsVehicles", source, vehicleInfoTable, patternInfoTable)
end)

RegisterServerEvent("pw_els:changeLightStage_s")
AddEventHandler("pw_els:changeLightStage_s", function(state, advisor, prim, sec)
	TriggerClientEvent("pw_els:changeLightStage_c", -1, source, state, advisor, prim, sec)
end)

RegisterServerEvent("pw_els:changePartState_s")
AddEventHandler("pw_els:changePartState_s", function(part, state)
	TriggerClientEvent("pw_els:changePartState_c", -1, source, part, state)
end)

RegisterServerEvent("pw_els:changeAdvisorPattern_s")
AddEventHandler("pw_els:changeAdvisorPattern_s", function(pat)
	TriggerClientEvent("pw_els:changeAdvisorPattern_c", -1, source, pat)
end)

RegisterServerEvent("pw_els:changeSecondaryPattern_s")
AddEventHandler("pw_els:changeSecondaryPattern_s", function(pat)
	TriggerClientEvent("pw_els:changeSecondaryPattern_c", -1, source, pat)
end)

RegisterServerEvent("pw_els:changePrimaryPattern_s")
AddEventHandler("pw_els:changePrimaryPattern_s", function(pat)
	TriggerClientEvent("pw_els:changePrimaryPattern_c", -1, source, pat)
end)

RegisterServerEvent("pw_els:toggleDfltSirenMute_s")
AddEventHandler("pw_els:toggleDfltSirenMute_s", function(toggle)
	TriggerClientEvent("pw_els:toggleDfltSirenMute_s", -1, source, toggle)
end)

RegisterServerEvent("pw_els:setSirenState_s")
AddEventHandler("pw_els:setSirenState_s", function(newstate)
	TriggerClientEvent("pw_els:setSirenState_c", -1, source, newstate)
end)

RegisterServerEvent("pw_els:setDualSirenState_s")
AddEventHandler("pw_els:setDualSirenState_s", function(newstate)
	TriggerClientEvent("pw_els:setDualSirenState_c", -1, source, newstate)
end)

RegisterServerEvent("pw_els:setDualSiren_s")
AddEventHandler("pw_els:setDualSiren_s", function(newstate)
	TriggerClientEvent("pw_els:setDualSiren_c", -1, source, newstate)
end)

RegisterServerEvent("pw_els:setHornState_s")
AddEventHandler("pw_els:setHornState_s", function(state)
	TriggerClientEvent("pw_els:setHornState_c", -1, source, state)
end)

RegisterServerEvent("pw_els:setTakedownState_s")
AddEventHandler("pw_els:setTakedownState_s", function(state)
	TriggerClientEvent("pw_els:setTakedownState_c", -1, source)
end)

RegisterServerEvent("pw_els:setSceneLightState_s")
AddEventHandler("pw_els:setSceneLightState_s", function(state)
	TriggerClientEvent("pw_els:setSceneLightState_c", -1, source)
end)

RegisterServerEvent("pw_els:setCruiseLights_s")
AddEventHandler("pw_els:setCruiseLights_s", function(state)
	TriggerClientEvent("pw_els:setCruiseLights_c", -1, source)
end)